...
<!--[if !mso]><!-->
<td align="center" class="padding-top-35 padding-right-35 padding-left-35 padding-bottom-35" style="padding: 16px">
<!--<![endif]-->
<!--[if mso]>
...
<!--[if !mso]><!-->
              ...
              margin:0;
              text-rendering: optimizeLegibility;">BRAND OF THE DAY:</h3>
<!--<![endif]-->
<!--[if mso]>
              <h3 class="h3" style="font-family: 'Avenir Regular', Arial, sans-serif;
              font-size: 22px;
...
`,f={title:"Douglas Redesign/03_Brand_of_the_Day",component:d},n={args:{text:"Wähle HTML-Story!"}},e={render:()=>s.jsx("div",{dangerouslySetInnerHTML:{__html:c}})};var t,r,i;n.parameters={...n.parameters,docs:{...(t=n.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {

import{j as d}from"./jsx-runtime-CDt2p4po.js";import"./index-GiUgBvb1.js";function s({text:p}){return d.jsx("p",{children:p})}s.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const c=`<table cellpadding="0" 
       cellspacing="0" 
       align="center" 
       width="600" 
       valign="center" 
...
<table cellpadding="0" cellspacing="0" align="center" style="word-break: break-word; color: #363636; text-align: left; background-color: transparent; word-wrap: break-word; width: 100%; max-width: 600px; padding-left: 20px; padding-right: 20px;">
    ...
    <p class="copy" e-editable="copy01_headline-image-text" style="text-align: center; padding-top: 10px; padding-bottom: 10px;">Regelmäßige Vorteile und Geschenke<br><strong>nur für App-User*innen</strong></p>
      ...
      </table>`,x={title:"Body/HeadlineImageTextButton",component:s},e={args:{text:"Was los?"}},n={render:()=>d.jsx("div",{dangerouslySetInnerHTML:{__html:c}})};var t,a,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    text: "Was los?"
  }
}`,...(r=(a=e.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};var o,l,i;n.parameters={...n.parameters,docs:{...(o=n.parameters)==null?void 0:o.docs,source:{originalSource:`{

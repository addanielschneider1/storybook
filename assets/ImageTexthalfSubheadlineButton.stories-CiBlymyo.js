import{j as l}from"./jsx-runtime-CDt2p4po.js";import"./index-GiUgBvb1.js";function d({text:p}){return l.jsx("p",{children:p})}d.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const c=`<table width="600" align="center" style="margin: 0px auto; width: 100% !important; max-width: 600px;" bgcolor="#ffffff"

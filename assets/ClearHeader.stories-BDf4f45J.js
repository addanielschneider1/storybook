import{j as c}from"./jsx-runtime-CDt2p4po.js";import"./index-GiUgBvb1.js";function m({text:d}){return c.jsx("p",{children:d})}m.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const l=`<div class="Styling aus css" style="background-color: #006ec7">
    <div class="Styling aus css">
      <h1>Hero Text</h1>
    </div>
</div>`,g={title:"Header/ClearHeader",component:m},e={args:{text:"Was los?"}},r={render:()=>c.jsx("div",{dangerouslySetInnerHTML:{__html:l}})};var t,n,s;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    text: "Was los?"
  }

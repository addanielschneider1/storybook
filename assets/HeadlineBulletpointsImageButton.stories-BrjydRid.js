import{j as p}from"./jsx-runtime-CDt2p4po.js";import"./index-GiUgBvb1.js";function d({text:s}){return p.jsx("p",{children:s})}d.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const c=`<table cellpadding="0" cellspacing="0" align="center" valign="center" width="542" style="word-break: break-word; color: #363636; text-align: left; background-color: transparent; word-wrap: break-word; padding-left: 15px; padding-right: 15px;">
    <tbody>

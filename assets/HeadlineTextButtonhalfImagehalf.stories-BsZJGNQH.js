import{j as s}from"./jsx-runtime-Cf8x2fCZ.js";import"./index-yBjzXJbu.js";function d({text:p}){return s.jsx("p",{children:p})}d.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const c=`<table width="540" align="center" class="wp100 dm_bg_grey" style="margin: 0px auto; width: 540px; max-width: 540px;" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0">
    <tbody>
      <tr>
            ...
            <tbody>
              <tr>
                        ...
                        <td height="190" class="hauto pt20" valign="top" style="height: 190px;">
                          ...
                          <e-optional name="text">
                            <p class="tac" style="margin: 0px; padding: 0px; text-align: left; color: rgb(0, 0, 0); line-height: 24px; letter-spacing: 1px; font-family: 'DFB Sans', Arial, Helvetica, sans-serif; font-size: 16px; font-weight: normal;" e-editable="text">
                              dolor sit amet, consetetur elitr, sed diam nonumy eirmod tempor invidunt ut labore. consetetur sadipscing.</p>
                          </e-optional>
                        </td>
                      </tr>
                      <tr>
                ...
                <th width="45%" class="moveup wp100s" valign="top" style="width: 45%;">
                  <table align="right" class="wp100s" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      <tr>
  ...
  </table>`,h={title:"Allgemein/Body/HeadlineTextButtonhalfImagehalf",component:d},e={args:{text:"Wähle HTML-Story!"}},t={render:()=>s.jsx("div",{dangerouslySetInnerHTML:{__html:c}})};var n,i,a;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    text: "Wähle HTML-Story!"
  }
}`,...(a=(i=e.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};var r,o,l;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
...
}`,...(l=(o=t.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};const x=["ReactStory","HtmlStory"];export{t as HtmlStory,e as ReactStory,x as __namedExportsOrder,h as default};

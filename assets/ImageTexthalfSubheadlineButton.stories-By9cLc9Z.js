import{j as l}from"./jsx-runtime-Cf8x2fCZ.js";import"./index-yBjzXJbu.js";function d({text:p}){return l.jsx("p",{children:p})}d.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const c=`<table width="600" align="center" style="margin: 0px auto; width: 100% !important; max-width: 600px;" bgcolor="#ffffff"
...
</table>`,u={title:"Body/ImageTexthalfSubheadlineButton",component:d},e={args:{text:"Was los?"}},t={render:()=>l.jsx("div",{dangerouslySetInnerHTML:{__html:c}})};var n,r,a;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    text: "Was los?"
  }
}`,...(a=(r=e.parameters)==null?void 0:r.docs)==null?void 0:a.source}}};var o,i,s;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
...
}`,...(s=(i=t.parameters)==null?void 0:i.docs)==null?void 0:s.source}}};const h=["ReactStory","HtmlStory"];export{t as HtmlStory,e as ReactStory,h as __namedExportsOrder,u as default};

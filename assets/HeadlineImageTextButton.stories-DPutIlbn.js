import{j as d}from"./jsx-runtime-Cf8x2fCZ.js";import s from"./HeadlineImageTextButton-BHHUrsO7.js";import"./index-yBjzXJbu.js";const p=`<table cellpadding="0" 
       cellspacing="0" 
       align="center" 
       width="600" 
       valign="center" 
...
<table cellpadding="0" cellspacing="0" align="center" style="word-break: break-word; color: #363636; text-align: left; background-color: transparent; word-wrap: break-word; width: 100%; max-width: 600px; padding-left: 20px; padding-right: 20px;">
    ...
    <p class="copy" e-editable="copy01_headline-image-text" style="text-align: center; padding-top: 10px; padding-bottom: 10px;">Regelmäßige Vorteile und Geschenke<br><strong>nur für App-User*innen</strong></p>
      ...
      </table>`,b={title:"Allgemein/Body/HeadlineImageTextButton",component:s},e={args:{text:"Wähle HTML-Story!"}},n={render:()=>d.jsx("div",{dangerouslySetInnerHTML:{__html:p}})};var t,a,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    text: "Wähle HTML-Story!"
  }
}`,...(r=(a=e.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};var l,o,i;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
...
}`,...(i=(o=n.parameters)==null?void 0:o.docs)==null?void 0:i.source}}};const x=["ReactStory","HtmlStory"];export{n as HtmlStory,e as ReactStory,x as __namedExportsOrder,b as default};

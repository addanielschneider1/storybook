import{j as l}from"./jsx-runtime-CDt2p4po.js";import"./index-GiUgBvb1.js";function i({text:d}){return l.jsx("p",{children:d})}i.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const c=`<table class="Stylig aus css" align="center" style="width: 100%; text-transform: uppercase; font-weight: bold; max-width: 600px; overflow: hidden;">
    <tr>

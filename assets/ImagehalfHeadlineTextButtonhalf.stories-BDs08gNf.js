import{j as s}from"./jsx-runtime-Cf8x2fCZ.js";import d from"./ImagehalfHeadlineTextButtonhalf-BHHUrsO7.js";import"./index-yBjzXJbu.js";const p=`<table width="540" align="center" class="wp100 dm_bg_grey" style="margin: 0px auto; width: 540px; max-width: 540px;" bgcolor="#ffffff" border="0" cellspacing="0" cellpadding="0">
    <tbody>
      <tr>
  ...
  </table>`,h={title:"Allgemein/Body/ImagehalfHeadlineTextButtonhalf",component:d},e={args:{text:"Wähle HTML-Story!"}},t={render:()=>s.jsx("div",{dangerouslySetInnerHTML:{__html:p}})};var n,a,i;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {

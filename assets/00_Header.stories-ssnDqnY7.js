import{j as s}from"./jsx-runtime-Cf8x2fCZ.js";import"./index-yBjzXJbu.js";function d({text:p}){return s.jsx("p",{children:p})}d.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const g=`    <div width="100%" style="max-width: 600px; background-color: {variables.bgcolorlogomenu}; margin: 0 auto;">
      ...
      <!-- Spacer -->
              ...
              <![endif]-->
      </div>`,x={title:"Douglas Redesign/00_Header",component:d},e={args:{text:"Wähle HTML-Story!"}},n={render:()=>s.jsx("div",{dangerouslySetInnerHTML:{__html:g}})};var t,i,r;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {

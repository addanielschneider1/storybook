import{j as o}from"./jsx-runtime-CDt2p4po.js";import"./index-GiUgBvb1.js";function d({text:c}){return o.jsx("p",{children:c})}d.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const p=`<table class="Styling aus css" cellpadding="0" align="center" cellspacing="0" style="margin:0 auto;width:100%;border-collapse: collapse;border-spacing: 0;" border="0" width="100%">
  ...
  <tr>
    ...
    </table>`,y={title:"Header/HLTextLuRFullColorBgFullwidth",component:d},t={args:{text:"Was los?"}},e={render:()=>o.jsx("div",{dangerouslySetInnerHTML:{__html:p}})};var n,r,a;t.parameters={...t.parameters,docs:{...(n=t.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    text: "Was los?"
  }
}`,...(a=(r=t.parameters)==null?void 0:r.docs)==null?void 0:a.source}}};var i,l,s;e.parameters={...e.parameters,docs:{...(i=e.parameters)==null?void 0:i.docs,source:{originalSource:`{
...
}`,...(s=(l=e.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const b=["ReactStory","HtmlStory"];export{e as HtmlStory,t as ReactStory,b as __namedExportsOrder,y as default};

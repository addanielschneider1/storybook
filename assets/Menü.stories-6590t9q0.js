import{j as p}from"./jsx-runtime-Cf8x2fCZ.js";import"./index-yBjzXJbu.js";function i({text:d}){return p.jsx("p",{children:d})}i.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const c=`<table class="Stylig aus css" align="center" style="width: 100%; text-transform: uppercase; font-weight: bold; max-width: 600px; overflow: hidden;">
    <tr>
  ...
  </table>`,x={title:"Allgemein/Header/Menu",component:i},e={args:{text:"Wähle HTML-Story!"}},t={render:()=>p.jsx("div",{dangerouslySetInnerHTML:{__html:c}})};var n,a,r;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
    text: "Wähle HTML-Story!"
  }
}`,...(r=(a=e.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};var s,o,l;t.parameters={...t.parameters,docs:{...(s=t.parameters)==null?void 0:s.docs,source:{originalSource:`{
...
}`,...(l=(o=t.parameters)==null?void 0:o.docs)==null?void 0:l.source}}};const h=["ReactStory","HtmlStory"];export{t as HtmlStory,e as ReactStory,h as __namedExportsOrder,x as default};

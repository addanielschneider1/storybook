import{j as l}from"./jsx-runtime-CDt2p4po.js";import"./index-GiUgBvb1.js";function d({text:m}){return l.jsx("p",{children:m})}d.__docgenInfo={description:"Primary UI component for user interaction",methods:[],displayName:"MailTemplate",props:{text:{required:!0,tsType:{name:"string"},description:""}}};const p=`<table class="Stylig aus css" cellpadding="0" cellspacing="0" align="center" style="word-break: break-word; word-wrap: break-word; width: 600px;">
    <tbody>
 <!-- Headline Start -->
...
`,g={title:"Body/Intro",component:d},e={args:{text:"Was los?"}},n={render:()=>l.jsx("div",{dangerouslySetInnerHTML:{__html:p}})};var t,r,a;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  args: {
    text: "Was los?"
  }
